...
class PauseScreen extends Screen {
  ...
  void onControlCode(int code) {
    ...
    switch(code) {
      case term.ESC: todo = options[0]; break;
      case term.LF:  todo = options[_curOption]; break;
      default: break;
    }
  ...
  void onControlSequence(List<int> codes) {
    ...
    switch(seqKey) {
      case term.SeqKey.ARROW_UP:   _curOption = _wrap(_curOption, -1, numOptions); break;
      case term.SeqKey.ARROW_DOWN: _curOption = _wrap(_curOption,  1, numOptions); break;
      default: break;
    }

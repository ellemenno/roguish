...
void testTerminal() {
  group('terminal', () {
    group('.seqKeyFromCodes()', () {
      test('provides a non-match value', () {
      ...
      test('matches numpad control keys', () {
      ...
      test('matches function keys', () {
        ...
        expect(term.seqKeyFromCodes([0x1b, 0x5b, 0x32, 0x33, 0x7e]), equals(term.SeqKey.f11));
